...
#SBATCH -J "rplfsall"   # job name

## /SBATCH -p general # partition (queue)
#SBATCH -o rplfsall-slurm.%N.%j.out # STDOUT
#SBATCH -e rplfsall-slurm.%N.%j.err # STDERR
...
hfall.save();"
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:480089422185:awsnotify --message "FSJobDone"
